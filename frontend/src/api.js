...
const api = {
  ...
  getTopRatingProducts: (category = 'kids') => axios.get(`${API_BASE_URL}/topRatingProducts/${category}`),
  ...
  // ==================== BLOG COMMENTS ====================
  addBlogComment: (blogId, commentData) => axios.post(`${API_BASE_URL}/innerBlog/${blogId}/comments`, commentData),
  ...
  // ==================== PRODUCT DETAILS ====================
  getProductDetails: (id) => axios.get(`${API_BASE_URL}/productDetails/${id}`),

  // ==================== REVIEWS ====================
  getProductReviews: (productId) => axios.get(`${API_BASE_URL}/productReviews?productId=${productId}`),
  addProductReview: (data) => axios.post(`${API_BASE_URL}/productReviews`, data),

  // ==================== USERS ====================
  getUsers: () => axios.get(`${API_BASE_URL}/users`),
  registerUser: (userData) => axios.post(`${API_BASE_URL}/users`, userData),
  loginUser: (credentials) => axios.post(`${API_BASE_URL}/users/login`, credentials),
};
